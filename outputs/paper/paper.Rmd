...
```{r echo = FALSE, fig-cohort, fig.cap='Children Ever Born by Mother\'s Age and Birth Cohort', fig.asp=1, fig.ncol = 1, out.width='.80\\linewidth', fig.align="center"}
knitr::include_graphics("./images/cohort.png")
```
...
"[@cite_original].
We reproduced the plot from [@cite_original] in Figure \@ref(fig:cohort-plot).
