...
LGBT is the acronym of the following 4 genders, **L** for Lesbian, **G** for gay, **B** for bisexual, **T** for transgender. By definition, these genders by definition should have a much lower birth rate than heterosexual. Thus, the population changes in these population are very likely to make an impact on the birth rate of the US.
...
This should make a even larger impact on birth rate as only females are able to give births (in normal situations).

Figure \@ref(fig:fig-gender-raising-children-distribution) (b) shows the percentage of LGBT population that raise children. 71% of the LGBT population don't raise children. With these information, we can conclude that the growth of LGBT population is able to cause a negative change in birth rate.
...
```{r echo = FALSE, fig-LGBT-socioeconomic-indicators, fig.cap='LGBT Socioeconomic Indicators', fig.asp=1, fig.ncol = 1, out.width='.80\\linewidth', fig.align="center"}
